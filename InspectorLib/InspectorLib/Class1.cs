...
namespace InspectorLib
{
    ...
    public class FunctionInsp
    {
        ...
        // Возвращает true, если изменение успешно, иначе false
        ...
        // Возвращает сформированный номер
        public string GenerateNumber(string number, string symbol, string code)
        {
            ...
            throw new ArgumentException("Неверный формат символа."); // Исключение при неверном формате
        }
